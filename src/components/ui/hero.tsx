...
export default function Hero() {
  return (
    <div className="bg-slate-100">
      ...
      <p className="flex ml-12 w-2/5 gap-y-4 space-y-5 text-gray-500 text-base tracking-wide">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia,
        veritatis sit, alias rem cumque ducimus, optio earum tempora sequi nulla
        voluptatibus dicta deserunt nisi culpa. Tempore omnis quam dicta
        similique.
      </p>
      <input
